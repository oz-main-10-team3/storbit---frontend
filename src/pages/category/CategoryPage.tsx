...
const dummyData = [
  {
    ...
    description:
      '파이썬으로 웹 데이터 수집부터 분석까지! BeautifulSoup, Selenium 사용법 배우고 실제 프로젝트 만들어봐요. 매주 실습 과제로 포트폴리오도 완성해요.',
    memberCount: 4,
    time: '월, 수 오후 8시',
  },
  {
    ...
    description:
      '넷플릭스, 인스타그램 같은 유명 서비스 클론코딩해봐요! 컴포넌트 설계부터 상태관리까지 실무 개발 경험 쌓으면서 취업 준비도 함께해요.',
    memberCount: 5,
    time: '토요일 오후 5시',
  },
  {
...
export default function CategoryPage() {
  ...
  const visibleNewStudies = newStudyData.slice(
    startIndex,
